 ...
 */
final class Version20240117184405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE access_token (token VARCHAR(128) NOT NULL, user_id INT NOT NULL, PRIMARY KEY(token))');
